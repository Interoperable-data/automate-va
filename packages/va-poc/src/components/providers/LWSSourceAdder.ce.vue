  ...
  <div class="container mb-3">
    <div class="input-group d-flex align-items-center">
      ...
      <button @click="addSource" class="btn btn-primary ml-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cloud-plus"
          viewBox="0 0 16 16">
    ...
    <small v-if="successMessage" class="form-text text-success">{{ successMessage }}</small>
  </div>
</template>
