...
We use the `@prefix era-sh: <http://data.europa.eu/949/shapes/>` and `@prefix era-sh-pava: <http://data.europa.eu/949/shapes/PAVA/>`.
...
eralex:PAVA-AnnexI a vpa:Requirement ;
  ...
  rdfs:member eralex:PAVA-AnnexI-1 , eralex:PAVA-AnnexI-2 , eralex:PAVA-AnnexI-11 # , ...
...
eralex:PAVA-AnnexII a vpa:Requirement ;
  ...
  vpa:section eralex:PAVA-AnnexII-1 , eralex:PAVA-AnnexII-2 , eralex:PAVA-AnnexII-11 # , ...
...
The sections represent the legal text of the individual requirement to be checked, extended with `era:shaclShapeValidationRule` if there is a SHACL-shape which could be applied to execute that assessment automatically:

#### Annex I

Annex I can be deduced from the completeness reports in OSS, and as `skos:Concept`s, they can be `vpa:section`s of the above `vpa:Requirement`s.
...
eralex:PAVA-AnnexI-1 a skos:Concept ;
  ...
  era:shaclShapeValidationRule era-sh-pava:CC_I_1 .
...
eralex:PAVA-AnnexI-2 a skos:Concept ;
  ...
  era:shaclShapeValidationRule era-sh-pava:CC_I_2 .

eralex:PAVA-AnnexI-3-1 a skos:Concept ;
  rdfs:label "(I) 3.1" ;
  skos:note "AUTOMATIC" ;
  era:shaclShapeValidationRule era-sh-pava:CC_I_31 ;
...
eralex:PAVA-AnnexI-3-2 a skos:Concept ;
  rdfs:label "(I) 3.2" ;
  skos:note "AUTOMATIC" ;
  era:shaclShapeValidationRule era-sh-pava:CC_I_32 ;
  rdfs:comment """3. The area of use is described in the application form, regarding the following aspects:
...
eralex:PAVA-AnnexI-3-3 a skos:Concept ;
  rdfs:label "(I) 3.3" ;
  skos:note "AUTOMATIC" ;
  era:shaclShapeValidationRule era-sh-pava:CC_I_33 ;
  rdfs:comment """3. The area of use is described in the application form, regarding the following aspects:
...
eralex:PAVA-AnnexI-3-4 a skos:Concept ;
  rdfs:label "(I) 3.4" ;
  skos:note "AUTOMATIC" ;
  era:shaclShapeValidationRule era-sh-pava:CC_I_34 ;
  rdfs:comment """3. The area of use is described in the application form, regarding the following aspects:
...
eralex:PAVA-AnnexI-3-5 a skos:Concept ;
  rdfs:label "(I) 3.5" ;
  skos:note "AUTOMATIC" ;
  era:shaclShapeValidationRule era-sh-pava:CC_I_35 ;
  rdfs:comment """3. The area of use is described in the application form, regarding the following aspects:
...
eralex:PAVA-AnnexI-4-1 a skos:Concept ;
  ...
  era:shaclShapeValidationRule era-sh-pava:CC_I_41 ;
...
eralex:PAVA-AnnexI-4-2 a skos:Concept ;
  ...
  era:shaclShapeValidationRule era-sh-pava:CC_I_42 ;
  rdfs:comment """The authorising entity issuing authority is identified in the application form and corresponds to:
...
eralex:PAVA-AnnexI-11 a skos:Concept ;
  ...
  skos:note "AUTOMATIC" ;
  era:shaclShapeValidationRule era-sh-pava:CC_I_11_1a , era-sh-pava:CC_I_11_1b .
# ...
eralex:PAVA-AnnexI-18-1 a skos:Concept ;
  ...
  era:shaclShapeValidationRule era-sh-pava:CC_I_18_1 .
```
...
eralex:PAVA-AnnexII-2 a skos:Concept ;
  ...
  era:shaclShapeValidationRule era-sh-pava:CC_II_2 ;
...
eralex:PAVA-AnnexII-3 a skos:Concept ;
  ...
  era:shaclShapeValidationRule era-sh-pava:CC_II_3 ;
...
eralex:PAVA-AnnexII-4 a skos:Concept ;
  ...
  era:shaclShapeValidationRule era-sh-pava:CC_II_4 ;
